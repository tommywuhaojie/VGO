...
public class TripSummaryFragment extends Fragment implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener, DialogInterface.OnCancelListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.trip_summary, container, false);
        this.view = view;

        // change toolbar title
        ((Main)getActivity()).setActionBarTitle("Summary");
        ...
        matchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Pass data arguments to FindTripFragment
                ...
                Fragment fragment = new FindTripFragment();
