...
public class FindTripFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.find_trip_fragment, container, false);
        this.view = view;

        // change toolbar title
        Toolbar toolbar = (Toolbar) getActivity().findViewById(R.id.toolbar);
        ((AppCompatActivity) getActivity()).setSupportActionBar(toolbar);
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Similar Trips");
        ...
        tripList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Fragment fragment = new RequestPageFragment();
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        ((Main)getActivity()).setActionBarTitle("Similar Trips");
