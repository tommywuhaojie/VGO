package v_go.version10.PersistentCookieStore;
...
public class SiCookieStore2 implements CookieStore {
    ...
    public static final String COOKIE_PREFS = "com.orb.net.cookieprefs";
     ...
     *            sharedPreferences to attach cookie store to
     */
    public SiCookieStore2(SharedPreferences sharedPreferences) {
